...
class _CustomListSelectionPageState extends State<CustomListSelectionPage> {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child:
          Consumer2<UserListContentSelectionProvider, CustomListSearchProvider>(
        ...
        return CupertinoPageScaffold(
          navigationBar: CupertinoNavigationBar(
            ...
            trailing: widget.isRecommendation
                ? null
                : Text(
                    "${_customListCreateProvider.selectedContent.length}/${authProvider.basicUserInfo?.isPremium == true ? "25" : "10"}"),
          ),
          child: Column(
            children: [
              Padding(
        ...
        return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final limit = widget.isRecommendation
                  ? 1
                  : authProvider.basicUserInfo?.isPremium == true
                      ? 25
                      : 10;
              final doesContain =
                  _customListCreateProvider.doesContain(content.id);

              return CustomListEntryCell(
                  _provider.selectedContent, content, doesContain,
                ...
                if (_customListCreateProvider.selectedContent.length < limit) {
                  _customListCreateProvider.addNewContent(CustomListContent(
                      0,
                      content.id,
                      content.externalId,
                  ...
                  showCupertinoDialog(
                      context: context,
                      builder: (_) => ErrorDialog(widget.isRecommendation
