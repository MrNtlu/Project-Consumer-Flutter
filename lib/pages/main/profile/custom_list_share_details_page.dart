...
class CustomListShareDetailsPage extends StatefulWidget {
  ...
  @override
  State<CustomListShareDetailsPage> createState() =>
      _CustomListShareDetailsPageState();
}

class _CustomListShareDetailsPageState
    extends State<CustomListShareDetailsPage> {
                        ...
                        Navigator.of(context, rootNavigator: true).push(
                          CupertinoPageRoute(
                            builder: (_) {
                              ...
                              return DetailsPage(
                                id: content.contentID.isNotEmpty
                                    ? content.contentID
                ...
                CupertinoButton(
                  onPressed: () async {
                    if (_authProvider.isAuthenticated) {
                      ...
                      provider.likeCustomList(widget.id).then(
                        (value) {
                          if (context.mounted) {
                ...
                CupertinoButton(
                  onPressed: () async {
                    if (_authProvider.isAuthenticated) {
                      ...
                      provider.bookmarkCustomList(widget.id).then(
                        (value) {
                          if (context.mounted) {
                            Navigator.pop(context);
