...
class Constants {
  ...
  static final AnimeStreamingPlatformList = [
    ...
    BackendRequestMapperWithImage("Aniplus TV", "Aniplus TV", image: "https://img.logo.dev/aniplus-asia.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("HIDIVE", "HIDIVE", image: "https://img.logo.dev/hidive.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Bilibili", "Bilibili", image: "https://img.logo.dev/bilibili.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Anime Digital Network", "Anime Digital Network", image: "https://img.logo.dev/animationdigitalnetwork.fr?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Shahid", "Shahid", image: "https://img.logo.dev/shahid.mbc.net?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
  ...
  static final GamePopularPublishersList = [ // 25 total
    BackendRequestMapperWithImage("Electronic Arts", "Electronic Arts", image: "https://img.logo.dev/ea.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Nintendo", "Nintendo", image: "https://img.logo.dev/nintendo.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Ubisoft Entertainment", "Ubisoft Entertainment", image: "https://img.logo.dev/ubisoft.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("SEGA", "SEGA", image: "https://img.logo.dev/sega.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    ...
    BackendRequestMapperWithImage("Capcom", "Capcom", image: "https://img.logo.dev/capcom.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Bandai Namco Entertainment", "Bandai Namco Entertainment", image: "https://img.logo.dev/bandainamcoent.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Sony Computer Entertainment", "Sony Computer Entertainment", image: "https://img.logo.dev/sonyinteractive.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    ...
    BackendRequestMapperWithImage("Bethesda Softworks", "Bethesda Softworks", image: "https://img.logo.dev/Bethesda.net?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("THQ Nordic", "THQ Nordic", image: "https://img.logo.dev/thqnordic.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Konami", "Konami", image: "https://img.logo.dev/konami.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("2K Games", "2K Games", image: "https://img.logo.dev/2k.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Warner Bros. Interactive", "Warner Bros. Interactive", image: "https://img.logo.dev/warnerbrosgames.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Devolver Digital", "Devolver Digital", image: "https://img.logo.dev/devolverdigital.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Focus Home Interactive", "Focus Home Interactive", image: "https://img.logo.dev/focus-entmt.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Feral Interactive", "Feral Interactive", image: "https://img.logo.dev/feralinteractive.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Valve", "Valve", image: "https://img.logo.dev/valvesoftware.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Rockstar Games", "Rockstar Games", image: "https://img.logo.dev/rockstargames.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("CD PROJEKT RED", "CD PROJEKT RED", image: "https://img.logo.dev/cdprojektred.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    ...
    BackendRequestMapperWithImage("Atlus", "Atlus", image: "https://img.logo.dev/atlus.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Aspyr", "Aspyr", image: "https://img.logo.dev/aspyr.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("Sony Interactive Entertainment", "Sony Interactive Entertainment", image: "https://img.logo.dev/sonyinteractive.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
    BackendRequestMapperWithImage("THQ", "THQ", image: "https://img.logo.dev/thqnordic.com?token=pk_C1fcC0OuSJS-HB9jCN0LIg"),
  ];
