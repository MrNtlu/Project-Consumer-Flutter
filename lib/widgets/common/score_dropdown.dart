                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: CupertinoPicker(
                      ...
                      children: List<Widget>.generate(widget.scoreList.length,
                          (int index) {
                        return Center(
                            child: Text(widget.scoreList[index].toString()));
                      }),
                    ),
                  ),
                ],
              ...
              child: Row(
                children: [
                  ...
                  Icon(Icons.arrow_drop_down,
                      size: 24, color: CupertinoTheme.of(context).bgTextColor)
                ],
              ),
            ),
          ],
