                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(DateTime.parse(season.airDate).dateToHumanDate(), style: const TextStyle(fontSize: 13), maxLines: 1, overflow: TextOverflow.ellipsis),
                      if (season.airDate.isEmpty)
                      const Text("Unknown", style: TextStyle(fontSize: 13)),
                      const SizedBox(height: 3),
                      Text("${season.episodeCount} eps.", style: const TextStyle(fontSize: 13), maxLines: 1, overflow: TextOverflow.ellipsis),
                    ],
                  ),
                ),
              ),
