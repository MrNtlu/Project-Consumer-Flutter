      ...
      child: Row(
        children: [
          SizedBox(
            height: 125,
            child: ContentCell(
              data.imageUrl?.replaceFirst("original", "w400") ?? '',
              ...
              child: Column(
                children: [
                  ...
                  LinearProgressIndicator(
                    value: data.watchedEpisodes != null &&
                            data.totalEpisodes != null
                        ? ((data.watchedEpisodes! * 100) /
                                data.totalEpisodes!) /
                            100
                          ...
                          onPressed: () {
                            switch (provider.selectedContent) {
                              case ContentType.tv:
                                ...
                                break;
                              default:
                                userListProvider.incrementUserList(index,
                                    IDBody(data.id), provider.selectedContent);
                            }
                          },
                          padding: EdgeInsets.zero,
                          minSize: 16,
