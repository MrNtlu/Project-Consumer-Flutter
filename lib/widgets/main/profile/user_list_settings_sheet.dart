  ...
  Widget build(BuildContext context) {
    ...
    final uiList = DiscoverSheetList(
      Constants.UserListUIModes.where(
        (element) => element == globalProvider.userListMode
      ).first,
          ...
          children: [
            ...
            CupertinoButton(
              onPressed: () {
                ...
                final newSort = Constants.SortUserListRequests.where((element) => element.name == sortList.selectedValue!).first.request;
                final newUIMode = Constants.UserListUIModes.where((element) => element == uiList.selectedValue!).first;
