...
class DiscoverSheetImageList extends StatefulWidget {
  ...
  DiscoverSheetImageList(this.selectedValue, this.list, this.imageList,
      {this.provider, this.isBiggerAndWideImage = false, super.key});
                      ...
                      child: CupertinoStreamingChip(
                          ...
                          leading: ClipRRect(
                            borderRadius: BorderRadius.circular(
                                widget.isBiggerAndWideImage ? 8 : 13),
                            child: ColoredBox(
                              color: widget.isBiggerAndWideImage
                                  ? CupertinoColors.white
                                  : CupertinoTheme.of(context).bgColor,
                              child: CachedNetworkImage(
                                ...
                                fit: widget.isBiggerAndWideImage
                                    ? BoxFit.contain
                                    : BoxFit.cover,
                                cacheManager: CustomCacheManager(),
                                maxHeightDiskCache: 75,
                                maxWidthDiskCache:
                                    widget.isBiggerAndWideImage ? 105 : 75,
                                progressIndicatorBuilder: (_, __, ___) =>
                                    ClipRRect(
                                        borderRadius: BorderRadius
                                            .circular(
                                                widget
                                                        .isBiggerAndWideImage
                                                    ? 8
                                                    : 13),
