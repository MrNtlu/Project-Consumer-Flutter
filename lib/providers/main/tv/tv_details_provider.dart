...
class TVDetailsProvider extends BaseDetailsProvider<TVDetails> {
  ...
  Future<BaseNullableResponse<TVWatchList>> createTVWatchList(TVWatchListBody body) async
    => createUserList<TVWatchListBody, TVWatchList>(body, url: APIRoutes().userListRoutes.tvUserList);

  Future<BaseNullableResponse<TVWatchList>> updateTVWatchList(TVWatchListUpdateBody body) async
    => updateUserList<TVWatchListUpdateBody, TVWatchList>(body, url: APIRoutes().userListRoutes.tvUserList);

  Future<BaseMessageResponse> deleteTVWatchList(DeleteUserListBody body) async
